...
async function main() {
  ...
  const stats = {
    ...
    rpcErrors1h: 0,
    rpcErrorRate1hPct: 0,
    shareValidationSamples1h: 0,
    shareValidationLatencyP50Ms: 0,
    shareValidationLatencyP95Ms: 0,
    ...
    lastZmqHashblockAt: 0,
    lastZmqHashblockHash: null,
    lastZmqHashblockSeq: null,
    zmqHashblockReconnects: 0,
    lastBroadcastAt: 0,
    ...
    bestShareAt: 0,
    bestLeadingZeros: 0,
    bestLeadingZerosHash: null,
    bestLeadingZerosWorker: null,
    bestLeadingZerosAt: 0,
    topShares: [],
    lastBlockCheckAt: 0,
